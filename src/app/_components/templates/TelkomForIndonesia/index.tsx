...
export const TelkomForIndonesia = ({ proportion }: { proportion: number }) => {
  const imageOneScale = proportion <= 0.5 ? 5 - 8 * proportion : 1;
  const imageTwoScale = proportion <= 0.5 ? 5 - 8 * proportion : 1;
  const imageThreeScale = proportion <= 0.5 ? 5 - 8 * proportion : 1;
  ...
  return (
    <Flex
      ...
      style={{
        rowGap: "56px",
        transform: `scale(${
          proportion < 0 ? 1.2 : proportion < 0.04 ? 1.2 - 5 * proportion : 1
        })`,
        overflow: "hidden",
      ...
      >
        {images.map((item, index) => (
          <Image
            key={item}
            style={{
              transform: `scale(${imageOneScale})`,
              zIndex: 10 - index,
              width: `calc(100%/${index === 0 ? 2 : images.length + 0.2})`,
      ...
      <Box
        style={{
          transform: `translate(0px, ${
            proportion < 0.5 ? 250 - 500 * proportion : 0
          }px)`,
          zIndex: 11,
          backgroundColor: "rgba(255,255,255,0.9)",
          boxShadow: "-39px -1px 72px 13px rgba(255,255,255,0.75)",
          opacity: (proportion - 0.2) / 0.3,
          position: "absolute",
          right: 0,
        }}
        width="50%"
      ...
      >
        ...
        <Box style={{ borderLeft: "1px solid #d0d5dd" }}>
          <Box
            ...
            style={{
              borderLeft:
                active === 0 ? "3px solid #e42313" : "3px solid transparent",
            }}
          >
          ...
          <Box
            ...
            style={{
              borderLeft:
                active === 1 ? "3px solid #e42313" : "3px solid transparent",
            }}
          >
          ...
          <Box
            ...
            style={{
              borderLeft:
                active === 2 ? "3px solid #e42313" : "3px solid transparent",
            }}
          >
